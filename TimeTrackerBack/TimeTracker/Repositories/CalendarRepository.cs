...
namespace TimeTracker.Repositories
{
    public class CalendarRepository : ICalendarRepository
    {
        ...
        {
            using var dapperConnection = _dapperContext.CreateConnection();
            dapperConnection.BulkInsert<CalendarEventViewModel>(addEventRange, (ce) => $"({userId}, N'{ce.Title}', {DapperBulk.GetDateString(ce.StartDate)}, {DapperBulk.GetDateString(ce.EndDate)})", "(UserId, Title, StartDate, EndDate)", "CalendarEvents");
        }
